...
function createCard(card){
    ...
    // const getQuestions = document.querySelector('.a');
    // console.log(getQuestions)

    // getQuestions.addEventListener('click', handleClick => {
    //     handleClick.setAttribute('display', 'block');
    // });
    ...
    //     pQuestion = ''
    //     pAnswer = ''
    //     pQuestion.forEach(question => {
    //     question.type.value === 'medium'
    //     })
    // }
